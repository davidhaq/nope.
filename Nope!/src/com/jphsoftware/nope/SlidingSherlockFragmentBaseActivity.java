...
public class SlidingSherlockFragmentBaseActivity extends
		SherlockFragmentActivity implements SlidingActivityBase {

	private int mTitleRes;

	public SlidingSherlockFragmentBaseActivity(int titleRes) {
		mTitleRes = titleRes;
	}
