...
public class BlocklistAdapter extends CursorAdapter {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        return inflator.inflate(R.layout.block_item, parent, false);
    }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        boolean contactedBefore = (lastContacted != -1337);
        if (contactedBefore) {
    ...
    private static int getDefaultAvatarResId(Context context, int extent) {
    ...
    private static int getDefaultAvatarResId(boolean hires) {
        if (hires)
            return R.drawable.ic_contact_picture_180_holo_light;
        return R.drawable.ic_contact_picture_holo_light;
    }

    void loadThumbnail(ImageView view, Uri contactUri) {
        if (contactUri == null) {
            // No photo is needed
